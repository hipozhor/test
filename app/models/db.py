...
class User(Base):
    ...
    default_city: Mapped[str | None] = mapped_column(String(128))
    ...
    favorites: Mapped[list["FavoriteCity"]] = relationship("FavoriteCity", back_populates="user", cascade="all, delete-orphan", lazy="selectin")
